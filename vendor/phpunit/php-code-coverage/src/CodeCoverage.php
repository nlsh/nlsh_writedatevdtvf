...
final class CodeCoverage
{
    ...
    public function append(array $data, $id=null, bool $append=true, $linesToBeCovered=[], array $linesToBeUsed=[], bool $ignoreForceCoversAnnotation=false): void
    {
        ...
        if ($id instanceof TestCase) {
            ...
            if ($_size === Test::SMALL) {
                $size = 'small';
            } else if ($_size === Test::MEDIUM) {
                $size = 'medium';
            } else if ($_size === Test::LARGE) {
                $size = 'large';
            }

            $status = $id->getStatus();
            $id     = \get_class($id) . '::' . $id->getName();
        } else if ($id instanceof PhptTestCase) {
            $size = 'large';
            $id   = $id->getName();
        }
    ...
    }//end setUnintentionallyCoveredSubclassesWhitelist()
    ...
    }//end applyCoversAnnotationFilter()
    ...
    }//end initializeFilesThatAreSeenTheFirstTime()
    ...
    }//end addUncoveredFilesFromWhitelist()
    ...
    }//end performUnintentionallyCoveredCodeCheck()
    ...
    }//end performUnexecutedCoveredCodeCheck()
    ...
    }//end processUnintentionallyCoveredUnits()
