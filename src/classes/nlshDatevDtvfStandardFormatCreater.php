<?php
    ...
    * Namespace
    */
namespace datevDtvfStandardFormatCreator\classes;
...
class nlshDatevDtvfStandardFormatCreater
{
     ...
     */
    public function __construct(string $strDefXmlFile='Resources/config/V8_DatevFelder.xml')
    {
         // Datev- Felder einlesen.
        $this->_initializeArrDefFromXmlFile($strDefXmlFile);

         // Zweite Zeile erzeugen.
        $this->_initializeSecondLine();

         // Array für Aufnahme der Daten erzeugen.
        $this->_initializeDataRowTemplate();
     ...
     * @return void
     */
    private function _initializeArrDefFromXmlFile(string $strDefXmlFile)
    {
    ...
    }//end _initializeArrDefFromXmlFile()
     ...
     * @return void
     */
    private function _initializeSecondLine()
    {
     ...
     * @return void
     */
    private function _initializeDataRowTemplate()
    {
        foreach ($this->arrDefFromXmlFile['Field'] as $value) {
    ...
    }//end _initializeDataRowTemplate()
    ...
    {
         // Erste Zeile.
        $strReturn = $this->_strPutCsv(array($this->arrFirstLine));
        ...
        foreach ($this->arrData as $value) {
            ...
            $strReturn .= $this->_strPutCsv(array($arrRowData));
        }
        ...
        if ($name === '') {
         ...
         $this->_downloadString($strReturn, $name);
        return(true);
     ...
     * @return false
     */
    private function _downloadString(string $string, string $filename)
    {
        if ($string === false) {
            return (false);
        }
     ...
     */
    private function _strPutCsv(array $data, string $delimiter=';')
    {
